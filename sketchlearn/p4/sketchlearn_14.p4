...
field_list_calculation sketch_hash { // hash function
    ...
    algorithm : random;  //NOTE: used to be csum8, but not defined in v1model.p4
    output_width : 8;
}
...
/**
NOTE! the following && used to be & (bitwise operator), however the compiler throws an error "&: not defined on operands of type bool"
Changed to & in order to pass the compilation.
**/
